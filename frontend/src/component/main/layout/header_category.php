...
<head>
    ...
    <body>
        ...
        <header class="header-area">
                            ...
                            <div class="header-middle-right f-right">
                                <div class="header-login">
                                    <a href="my_order.php">
                                        ...
                                        <div class="login-text-content" style="margin-top: 10px;">
                                            <p class="">User Name</p>
                                        </div>
                                    </a>
                                ...
                                <div class="cart-header">
                                  <a href="cart-page.php">
                                    <div class="header-icon-style">
                                        ...
                                        <div class="cart-text" style="margin-top: 10px;">
                                            <!--<span class="digit">My Cart</span>-->
                                            <span class="cart-digit-bold">$00.00</span>
                                        </div>
                                  </a>
                                </div>
            ...
            <div class="mobie_menu_box">
                <div class="header-middle-right f-right">
                    <div class="header-login">
                        <a href="my_order.php">
                            <div class="header-icon-style" style="margin-top:6px;">
                                <i class="icon-user icons"></i>
                            </div>
                    ...
                    <div class="cart-header">
                      <a href="cart-page.php">
                        ...
                        <div class="cart-text" style="margin-top:12px;">
                            <!--<span class="digit">My Cart</span>-->
                            <span class="cart-digit-bold">$00.00</span>
                        </div>
                      </a>
